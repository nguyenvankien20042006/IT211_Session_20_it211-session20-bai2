package com.example.bai2.security.jwt;

import com.example.bai2.security.principal.AccountPrincipal;
import com.example.bai2.security.principal.AccountPrincipalService;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (token != null && jWTProvider.validateToken(token)) {
            ...
            AccountPrincipal accountPrincipal = (AccountPrincipal) accountPrincipalService.loadUserByUsername(username);
